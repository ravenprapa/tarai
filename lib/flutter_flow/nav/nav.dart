...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      routes: [
        ...
        FFRoute(
          name: 'pinmenu',
          path: '/pinmenu',
          builder: (context, params) => const PinmenuWidget(),
        ),
        FFRoute(
          name: 'addstock',
          path: '/addstock',
        ...
        FFRoute(
          name: 'tarmenu',
          path: '/tarmenu',
          builder: (context, params) => const TarmenuWidget(),
        ),
        FFRoute(
          name: 'par',
          path: '/par',
          builder: (context, params) => ParWidget(
            ...
            upload: params.getParam(
              'upload',
              ParamType.int,
            ),
            item: params.getParam<ItemsRow>(
              'item',
        ...
        FFRoute(
          name: 'notion',
          path: '/notion',
          builder: (context, params) => const NotionWidget(),
        ),
        FFRoute(
          name: 'at1',
          path: '/at1',
          builder: (context, params) => At1Widget(
        ...
        FFRoute(
          name: 'space',
          path: '/space',
          builder: (context, params) => const SpaceWidget(),
        ),
        FFRoute(
          name: 'a3edit',
          path: '/a3edit',
          builder: (context, params) => const A3editWidget(),
        ),
        FFRoute(
          name: 'site',
          path: '/site',
          builder: (context, params) => SiteWidget(
            par: params.getParam<ParRow>(
              'par',
              ParamType.SupabaseRow,
            ),
          ),
        ...
        FFRoute(
          ...
          builder: (context, params) => PostsWidget(
            ...
            collections: params.getParam<ParncollRow>(
              'collections',
              ParamType.SupabaseRow,
            ),
          ),
        ...
        FFRoute(
          name: 'spaces1',
          path: '/spaces1',
          builder: (context, params) => const Spaces1Widget(),
        ),
        FFRoute(
          name: 'texts',
          path: '/texts',
        ...
        FFRoute(
          name: 'items1',
          path: '/items1',
          builder: (context, params) => const Items1Widget(),
        ),
        FFRoute(
          name: 'itemdetails1',
          path: '/itemdetails1',
          builder: (context, params) => Itemdetails1Widget(
            item: params.getParam<GetItemsRow>(
              'item',
              ParamType.SqliteRow,
            ),
          ),
