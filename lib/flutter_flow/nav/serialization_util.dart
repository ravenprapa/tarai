    ...
    switch (paramType) {
      ...
      case ParamType.SupabaseRow:
        ...
        switch (T) {
          ...
          case ParncollRow:
            return ParncollRow(data);
          case MenuRow:
            return MenuRow(data);
          case ParRow:
            return ParRow(data);
          case SpacesRow:
            return SpacesRow(data);
          case PCompRow:
            return PCompRow(data);
          default:
            return null;
        }
      ...
      case ParamType.SqliteRow:
        ...
        switch (T) {
          case GetcartitemRow:
            return GetcartitemRow(data);
          case GetCartRow:
            return GetCartRow(data);
          case GetChatsRow:
            return GetChatsRow(data);
          case GetItemsRow:
            return GetItemsRow(data);
          default:
            return null;
        }
