  ...
  Widget build(BuildContext context) {
    ...
    return FutureBuilder<List<ItemsRow>>(
      ...
      builder: (context, snapshot) {
        ...
        List<ItemsRow> itemsItemsRowList = snapshot.data!;
            ...
            appBar: AppBar(
              ...
              title: Row(
                ...
                children: [
                  ...
                  Padding(
                    padding:
                        const EdgeInsetsDirectional.fromSTEB(14.0, 0.0, 1.0, 0.0),
                    child: InkWell(
                      splashColor: Colors.transparent,
                      focusColor: Colors.transparent,
                      hoverColor: Colors.transparent,
              ...
              child: Column(
                ...
                children: [
                  Expanded(
                    child: Builder(
                      builder: (context) {
                        final items = itemsItemsRowList.toList();
                        return FlutterFlowDataTable<ItemsRow>(
                              ...
                              label: DefaultTextStyle.merge(
                                ...
                                child: Align(
                                  ...
                                  child: InkWell(
                                    ...
                                    highlightColor: Colors.transparent,
                                    onTap: () async {
                                      _model.code = await FlutterBarcodeScanner
                                          .scanBarcode(
