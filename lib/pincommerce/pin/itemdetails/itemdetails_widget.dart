  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      setState(() {
        _model.type = 0;
        _model.name = 'details';
        _model.spec = widget.items!.speclist.toList().cast<dynamic>();
      });
      setState(() {
        FFAppState().spec = functions
            ...
            .toList()
            .cast<SpecsStruct>();
        FFAppState().specjson = widget.items!.speclist.toList().cast<dynamic>();
      });
    });
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    Padding(
                                      ...
                                      child: Builder(
                                        builder: (context) {
                                          final specs = FFAppState()
                                              .specjson
                                              .map((e) =>
                                                  SpecsStruct.maybeFromMap(e))
                                              .withoutNulls
                                              .toList();
