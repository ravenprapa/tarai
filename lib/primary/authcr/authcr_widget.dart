...
import 'authcr_model.dart';
export 'authcr_model.dart';

class AuthcrWidget extends StatefulWidget {
  const AuthcrWidget({super.key});

  @override
  State<AuthcrWidget> createState() => _AuthcrWidgetState();
}

class _AuthcrWidgetState extends State<AuthcrWidget> {
  late AuthcrModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => AuthcrModel());
