...
import 'notion_model.dart';
export 'notion_model.dart';
...
class _NotionWidgetState extends State<NotionWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => NotionModel());
            ...
            children: [
              ...
              Padding(
                ...
                child: InkWell(
                  ...
                  onTap: () async {
                    await launchURL(
                        'https://api.notion.com/v1/oauth/authorize?client_id=367b8c35-7c0b-431b-aa59-731678550b8d&response_type=code&owner=user&redirect_uri=https%3A%2F%2Ftar.parai.space%2Fterms');
                  },
                  child: Container(
                    height: 50.0,
              ...
              Padding(
                ...
                child: FFButtonWidget(
                  onPressed: () async {
                    _model.notiontoken = await NotionaccesstokenCall.call(
                      code: _model.codeTextController.text,
                    );
                    if ((_model.notiontoken?.succeeded ?? true)) {
                      await ParTable().insert({
                        'plan': 'notioncms',
                        'accesstoken': getJsonField(
                          (_model.notiontoken?.jsonBody ?? ''),
                          r'''$.access_token''',
                        ).toString(),
                        ...
                        'notionint': (_model.notiontoken?.jsonBody ?? ''),
                      });
                    }
